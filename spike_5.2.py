# -*- coding: utf-8 -*-
"""
Created on Mon Mar  1 02:17:32 2021
...
# -*- coding: utf-8 -*-
"""
Created on Wed Feb  3, 2021 (version 5)
Edited  on Fri Feb 26, 2021 (version 5.1)

@authors: Lilian Caroline Kramer Biasi and Opalina Vetrichelvan

Laboratory of Complex Systems Engineering - University of Campinas
"""
...
#receptor:
# =============================================================================
# print("Enter the receptor name:")
# receptor_name = str(input())
# =============================================================================
#receptor_name = "7kdj_v2.pdbqt"
receptor_name = "6vsb_1_1_1_nosugar_v3.pdbqt"
...
result_file.write("#################################################################\n\n\n")
result_file.write("Simulation Informations (Input data):\n")
...
out_file.write("#################################################################\n\n\n")
out_file.write("Simulation Informations (Input data):\n")
...
out_file.write("*  Lowest biding energy: "+  str(min(val))+ " kcal/mol, Component: " + str(get_key(ligand_dict,min(val),0))+ "\n")
...
resp=np.stack((Ligand_name, val, avg_val, median_val)).T
df2 = pd.DataFrame (resp)
df2.columns=["Ligand", "Lowest biding energy", "Lowest average biding energy", 
             "Lowest median biding energy"]
